local description <const> = [[I just did something which I thought was worth sharing.  It shows a couple of fundamental techniques in unix systems used in a context where most people would not think of.]]
...
From inside vim, I executed the following command:
    ...
    code [[
:!ssh raspberrypi <b>'nc -l 31415 > /srv/http/sufle.txt'</b> &
]],
    par [[
