...
call trace.
    ...
    h2_link { "minimal-elf", "Minimal ELF" },
    par [[
...
crafted which results in an almost empty trace.
    ...
    code [[
$ as <a href="strace-prelude-in-c/min.s">min.s</a> -o min.o
...
70x larger).
    ...
    code [[
$ gcc -std=c17 -static -nostdlib -O2 <a href="strace-prelude-in-c/min.c">min.c</a>
...
<b>int</b> main(<b>void</b>) {}
    ...
    code [[
$ musl-gcc -std=c17 -static <a href="strace-prelude-in-c/libc.c">libc.c</a>
$ env -i strace ./a.out
...
<code>LIBC_START_MAIN</code> macro, for those following the code).
    ...
    code [[
$ gcc -std=c17 -static -O2 <a href="strace-prelude-in-c/libc.c">libc.c</a>
$ env -i strace ./a.out
...
format also details some of the <code>glibc</code> linker implementation.
    ...
    code [[
$ gcc -std=c17 -O2 <a href="strace-prelude-in-c/libc.c">libc.c</a>
$ env -i strace ./a.out
...
maintainer of Linux manual pages) is a fantastic resource.
    ...
    tag("a", {href = "/files/blog/strace0.png"}, image {
        title = "tlpi",
        alt = "tlpi",
        src = "/files/blog/strace0_512.png",
    }),
    par [[
Have fun!
]],
